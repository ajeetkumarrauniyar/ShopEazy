...
const ResetButtonDevOnly = () => {
  ...
  const handleClearDatabase = async () => {
    Alert.alert("Clear Database", "Choose how to clear the database:", [
      {
        text: "Cancel",
        style: "cancel",
      },
  ...
  return (
    <>
      <Button onPress={handleReset} style={{ marginBottom: 20 }}>
        Reset Onboarding & Sign Out (Dev Only)
      </Button>

      <Button onPress={handleClearDatabase} style={{ marginBottom: 20 }}>
